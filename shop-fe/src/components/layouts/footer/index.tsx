        ...
        <footer>
            <div className={cx('container')}>
                <div className={cx('item')}>
                    ...
                    <div className={cx('ip-ft')}>
                        <input type="text" placeholder="Enter your email" />
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.91196 11.9998H3.99996L2.02296 4.1348C2.0103 4.0891 2.00259 4.04216 1.99996 3.9948C1.97796 3.2738 2.77196 2.7738 3.45996 3.1038L22 11.9998L3.45996 20.8958C2.77996 21.2228 1.99596 20.7368 1.99996 20.0288C2.00198 19.9655 2.0131 19.9029 2.03296 19.8428L3.49996 14.9998" stroke="#FAFAFA" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                ...
                <div className={cx('item')}>
                    <h3>Download App</h3>
                    <img src="src/public/images/Frame 719.png" alt="" />
                    <div className={cx('icon-app')}>
                        <a href="https://www.facebook.com/nttl1308"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={cx('copyright')}>
                <div><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.4998 18.3332C15.1022 18.3332 18.8332 14.6022 18.8332 9.99984C18.8332 5.39746 15.1022 1.6665 10.4998 1.6665C5.89746 1.6665 2.1665 5.39746 2.1665 9.99984C2.1665 14.6022 5.89746 18.3332 10.4998 18.3332Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M12.9998 8.14799C12.9998 8.14799 11.9704 6.6665 10.2547 6.6665C8.53905 6.6665 7.1665 8.14799 7.1665 9.99984C7.1665 11.8517 8.53905 13.3332 10.2547 13.3332C11.9704 13.3332 12.9998 11.8517 12.9998 11.8517" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                </div>
